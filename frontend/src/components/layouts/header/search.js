...
const add_class = (ele_of_suggestions, index_to_add) => {
    ele_of_suggestions[index_to_add].classList.add('arrow_down_focusing')
}

const Search = ({ handleSetSuggestions, suggestionRef, handleSubmitSearch }) => {
    ...
    const catchArrowKeyboard = e => {
        ...
        let ele_of_suggestions = suggestionRef.current.children
...
const SearchSection = ({ handleOpenSearch }) => {
    ...
    return (
        ...
        >
            ...
            <Suggestions suggestions={suggestions} ref={suggestion_ref} />
